...
> Stato attuale: **v0.9.3** — editor IT/EN (multi-selezione, allinea/distribuisci, copia/incolla, galleria schermate), lato citofono, installazione SSH, show/hide via API.
